...
import {
    auditProductList, searchProductForOutId, returnOutProductListData, getOutProductLength
} from '@/api/product.js'
...
const getOutProductListLength = async () => {
    const res = (await getOutProductLength()).data
...
const currentChange = async (value: number) => {
    ...
    tableData.value = (await returnOutProductListData(paginationData.currentPage)).data
}
//////////////////////////


//const fetchauditProductList = async () => {
//    tableData.value = (await auditProductList()).data
//}
//fetchauditProductList()
