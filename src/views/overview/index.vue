                ...
                <el-row :gutter="20">
                    <el-col :span="6">
                        <div class="button-area" @click="routerTo('users_manage')">
                            <SvgIcon icon-name="user" style="width: 12px;height: 12px;"></SvgIcon>
                            <span class="button-name">用户管理</span>
                        </div>
                    </el-col>
                    <el-col :span="6">
                        <div class="button-area" @click="routerTo('product_management')">
                            <SvgIcon icon-name="product" style="width: 12px;height: 12px;"></SvgIcon>
                            <span class="button-name">产品管理</span>
                        </div>
                    </el-col>
                    <el-col :span="6">
                        <div class="button-area" @click="routerTo('message_list')">
                            <SvgIcon icon-name="notice" style="width: 12px;height: 12px;"></SvgIcon>
                            <span class="button-name">系统消息</span>
                        </div>
                    </el-col>
                    <el-col :span="6">
                        <div class="button-area" @click="routerTo('set')">
                            <SvgIcon icon-name="me" style="width: 12px;height: 12px;"></SvgIcon>
                            <span class="button-name">个人信息</span>
                        </div>
                    </el-col>
                    <el-col :span="6">
                        <div class="button-area">
                            <SvgIcon icon-name="message" style="width: 12px;height: 12px;"></SvgIcon>
                            <span class="button-name">部门信息</span>
                        </div>
                    </el-col>
                    <el-col :span="6">
                        <div class="button-area" @click="routerTo('set')">
                            <SvgIcon icon-name="set" style="width: 12px;height: 12px;"></SvgIcon>
...
const fetchUserInfo = async () => {
    const res = (await getUserInfo(localStorage.getItem('id'))).data
...
const manageUser = async () => {
    ...
    mu.showLoading()
    let data = (await getAdminAndNumber()).data
    mu.hideLoading()
...
const productCategoryBar = async () => {
    ...
    pcb.showLoading()
    let data = (await getCategoryAndNumber()).data
    pcb.hideLoading()
...
const massageLevel = async () => {
    ...
    ml.showLoading()
    let data = (await getLevelAndNumber()).data
    ml.hideLoading()
...
const massageAllDay = async () => {
    ...
    mad.showLoading()
    let data = (await getDayAndNumber()).data
    mad.hideLoading()
